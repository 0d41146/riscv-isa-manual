...
|inst[6:5]
|00           |LOAD   |LOAD-FP  |OP-CFU     |MISC-MEM |OP-IMM |AUIPC      |OP-IMM-32       |48b
...
15+^|*Custom Instruction Set*
 4+^|0000000        2+^|imag   2+^|real   2+^|001    2+^|00000           2+^|0001011 <|CFU_STORE
 4+^|0000000        2+^|00000   2+^|twiddle   2+^|010    2+^|00000           2+^|0001011 <|CFU_EXEC
 4+^|0100000        2+^|00000   2+^|00000   2+^|100    2+^|rd           2+^|0001011 <|CFU_LOAD
|===
[%autowidth.stretch,float="center",align="center",cols="^2m,^2m,^2m,^2m,<2m,>3m, <4m, >4m, <4m, >4m, <4m, >4m, <4m, >4m, <6m"]
|===
